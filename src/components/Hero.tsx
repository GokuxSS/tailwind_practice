import ArrowSvg from "../assets/icons/arrow-w.svg"
...
export const Hero = () => {
  return (
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip">
      ...
      <div className="absolute h-[375px] w-[750px] sm:w-[1536px] sm:h-[768px] lg:w-[2600px] lg:h-[1200px] rounded-[100%] bg-black left-1/2 -translate-x-1/2 border-[#B48CDE] bg-[radial-gradient(closest-side,#000_82%,#9560EB)] top-[calc(100%-96px) sm:top-[calc(100%-120px)]">
      </div>
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
           ...
           <Image src={messageImage} alt="" height="200" width="200" className="absolute top-[56px] left-[498px] sm:inline"/>
          </div>
        </div>
